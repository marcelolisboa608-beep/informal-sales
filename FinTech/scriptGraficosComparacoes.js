...
async function gerarExplicacao(resumo) {
    const res = await fetch("http://localhost:3000/api/explicar-semana", {
        method: "POST",
...
async function gerarExplicacaoComparacaoMensal(resumo) {
    const res = await fetch("http://localhost:3000/api/explicacao-mes", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(resumo)
    });
...
async function gerarExplicacaoCrescimentoCategoria(resumo) {
    const res = await fetch("http://localhost:3000/api/explicacao-crescimento-categoria", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(resumo)
    });
