...
async function gerarExplicacao(resumo) {
    const res = await fetch("http://localhost:3000/api/explicacao-vendas-ultimos-7-dias", {
        method: "POST",
...
async function gerarExplicacao1(resumo) {
    const res = await fetch("http://localhost:3000/api/explicacao-top5-produtos-mais-vendidos", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(resumo)
    });
...
async function gerarExplicacao2(resumo) {
    const res = await fetch("http://localhost:3000/api/explicacao-top5-produtos-mais-lucrativos", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(resumo)
    });
...
async function gerarExplicacao3(resumo) {
    const res = await fetch("http://localhost:3000/api/explicacao-top5-categorias-mais-lucrativas", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(resumo)
    });
